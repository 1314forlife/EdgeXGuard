...
PTZBindingProxy::PTZBindingProxy(const struct soap &_soap, const char *soap_endpoint_url) : soap(_soap)
{
	soap_endpoint = soap_endpoint_url;
}

PTZBindingProxy::PTZBindingProxy(const char *soap_endpoint_url) : soap(SOAP_IO_DEFAULT)
{	PTZBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = soap_endpoint_url;
}
...
PTZBindingProxy::PTZBindingProxy(const char *soap_endpoint_url, soap_mode iomode) : soap(iomode)
{	PTZBindingProxy_init(iomode, iomode);
	soap_endpoint = soap_endpoint_url;
}
