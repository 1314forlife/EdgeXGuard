...
void Demuxer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Demuxer::*)()>(_a, &Demuxer::sigStreamsReady, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Demuxer::*)(const QString & )>(_a, &Demuxer::sigError, 1))
            return;
    }
}
...
// SIGNAL 0
void Demuxer::sigStreamsReady()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Demuxer::sigError(const QString & _t1)
{
