/****************************************************************************
** Meta object code from reading C++ file 'opengl_renderer.h'
**
...
#error "The header file 'opengl_renderer.h' doesn't include <QObject>."
...
template <> constexpr inline auto OpenGLRenderer::qt_create_metaobjectdata<qt_meta_tag_ZN14OpenGLRendererE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'updateFrame'
        QtMocHelpers::SlotData<void(const FrameData &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void OpenGLRenderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateFrame((*reinterpret_cast<std::add_pointer_t<FrameData>>(_a[1]))); break;
        default: ;
        }
    }
}
